...
@foreach($attendees as $attendee)
    ...
    <div style="position:absolute;top:1.04in;left:0.12in;width:0.82in;line-height:0.12in;"><span
                style="font-style:normal;font-weight:normal;font-size:7pt;font-family:HelveticaNeue;color:#000000">{{ $attendee->first_name }} </span></SPAN>
        <br/></div>
    <div style="position:absolute;top:1.15in;left:0.12in;width:0.82in;line-height:0.12in;"><span
                style="font-style:normal;font-weight:normal;font-size:7pt;font-family:HelveticaNeue;color:#000000">{{ $attendee->last_name }} </span></SPAN>
        <br/></div>
    @endif
@endforeach
